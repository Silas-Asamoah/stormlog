...
_SYMBOL_TO_MODULE = {
    ...
    "TimelineMarker": (".timeline_markers", "TimelineMarker"),
    "derive_timeline_markers": (".timeline_markers", "derive_timeline_markers"),
    "derive_session_timeline_markers": (
        ".timeline_markers",
        "derive_session_timeline_markers",
    ),
    "timeline_marker_to_dict": (".timeline_markers", "timeline_marker_to_dict"),
